...
function addToHistory() { //A function that allows you to add mathematical operations to the history
    if (document.forms[0][0].value === "" || document.forms[0][2].value === "") {
        ...
        } else history.push(firstNumber + " " + select + " " + secondNumber + " " + result.innerHTML);
        
        if (HistoryRecord(i)[1] == "d1") mathOperation = " + ";
        else if (HistoryRecord(i)[1] == "d2") mathOperation = " - ";
        else if (HistoryRecord(i)[1] == "d3") mathOperation = " × ";
        else if (HistoryRecord(i)[1] == "d4") {
            if (secondNumber == 0) result.innerHTML = "";
            else mathOperation = " ÷ ";
        } else if (HistoryRecord(i)[1] == "d5") {
        ...
        if (HistoryRecord(i)[1] == "d1" || HistoryRecord(i)[1] == "d2" || HistoryRecord(i)[1] == "d3" || HistoryRecord(i)[1] == "d4") {
